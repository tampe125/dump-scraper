...
class DumpScraperScrapeold(AbstractCommand):
    def run(self):
        base_url = 'https://twitter.com/i/search/timeline?q='
        ...
        while processing:
            ...
            html = LH.fromstring(json_data['items_html'])

            removed = 0

            for tweet in html.cssselect('.original-tweet'):
            ...
            processing = json_data['has_more_items']
